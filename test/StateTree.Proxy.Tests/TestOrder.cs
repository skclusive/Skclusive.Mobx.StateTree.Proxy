...
namespace Skclusive.Mobx.StateTree.Proxy.Tests
{
    #region IOrder
    ...
    public class TestOrder
    {
        ...
        {
            var order = Order.Create(new Dictionary<string, object> { { "Vat", 3.0 } });

            var target = Order.Create(new Dictionary<string, object> { { "Vat", 1.0 } });
